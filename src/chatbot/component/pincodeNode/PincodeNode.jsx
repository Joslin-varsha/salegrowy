...
function PincodeNode({ data, selected, id }) {
      ...
      <div className="flex flex-col">
        ...
        <div className="px-3 py-2 text-left text-white text-xs font-semibold rounded-t-lg bg-gradient-to-r from-blue-500 to-indigo-500 flex justify-between items-center">
          <span className="flex items-center gap-1">
            <MessageCircle size={14} className="opacity-90" /> Pincode Node
          </span>
        ...
        <div className="px-4 py-3 text-xs text-black">
          <div className="py-2">
            ...
            >
              {!data.label || data.label === "pincodenode"
                ? "Type your name here..."
                : data.label}
            </p>

            {/* True button with its own source handle */}
            <div className="relative mt-2">
              <button
                className="border-[1px] rounded-[3px] border-blue-600 p-1 flex flex-col items-start text-white w-full font-bold bg-blue-600"
              >
                <span>True</span>
              </button>
              <Handle
            ...
            {/* False button with its own source handle */}
