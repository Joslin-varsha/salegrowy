...
export default function AiProductSidebar({
  selectedNode,
  nodeId,
  setSelectedElements,
  isNewNode,
  ...
  useEffect(() => {
    ...
    setFormData({
      name: selectedNode.data.label === "aiProductNode" ? "" : selectedNode.data.label || "",
            ...
            n.id === nodeId
              ? {
                ...
                data: {
                  ...
                  replyWebhookUrl: data.data.reply_webhook_url || "",
                  isAdded: false,
                },
              }
              : n
  ...
  const updateAiProductBot = async (e) => {
    e.preventDefault();
    ...
    try {
      ...
      if (err.name === "ValidationError") {
        ...
        console.error("Error updating AI Product:", err);
        Modal.error({
          title: "Error",
          content: "Something went wrong. Please try again later.",
          centered: true,
