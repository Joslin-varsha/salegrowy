...
function ReminderNode({ data, selected, id }) {
      ...
      <div className="flex flex-col">
        ...
        <div className="px-3 py-2 text-left text-white text-xs font-semibold rounded-t-lg bg-gradient-to-r from-blue-500 to-indigo-500 flex justify-between items-center">
          <span className="flex items-center gap-1">
            <Clock size={14} className="opacity-90" /> Reminder Bot
          </span>
        ...
        <div className="p-3">
          <div className="relative">
            <div
              className="w-16 mt-2 pt-3 h-16 mx-auto mb-3 rounded-full bg-gradient-to-br from-indigo-500 to-indigo-600 
                      flex flex-col items-center justify-center text-white relative shadow-md"
            >
              <Clock size={16} className="absolute top-3 opacity-80" />
              <div className="flex flex-col items-center justify-center text-center">
                {data.time ? (
                  <>
                    <span className="text-sm font-bold leading-none">{data.time}</span>
                    {data.date && (
                  ...
                  <span className="text-[10px] px-1">Set Time</span>
                )}
              </div>
            </div>
            <div className="text-sm font-medium text-gray-700 text-center truncate px-2">
              {formatLabel(data.label || "Reminder")}
            </div>
          </div>
        </div>
      </div>
