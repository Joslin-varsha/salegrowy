...
const AIAgent = () => {
  ...
  const fetchShopifyAccessToken = async (code) => {
    try {
      ...
      setTokenError(null);
      const response = await axios.post(`${BASE_URI}/api/getAccessTokenShopify`, {
        vendor_id: vendorId,
        code: code
  ...
  const fetchAiStatus = async () => {
    try {
      const response = await axios.post(`${BASE_URI}/api/getWidgetAi`, { vendor_id: vendorId }, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
  ...
  const handleSaveShopifyDetailsAndGetToken = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${BASE_URI}/api/storeShopifyDetails`, {
        vendor_id: vendorId,
        client_id: clientId,
  ...
  const toggleAiStatus = async () => {
    ...
    try {
      const response = await axios.post(`${BASE_URI}/api/enableDisableWidgetAi`, {
        vendor_id: vendorId,
  ...
  const toggleWidgetStatus = async () => {
    ...
    try {
      const response = await axios.post(`${BASE_URI}/api/widgetToggle`, {
        vendor_id: vendorId,
...
const KnowledgeBaseContent = ({ setShowRedirectDialog, vendorId }) => {
  ...
  const handleTrainAgent = async () => {
    try {
      ...
      const response = await axios.post(`${BASE_URI}/api/processShopifyProductTraining`, { 
        vendor_id: vendorId
      }, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
  ...
  const handleTrainWooAgent = async () => {
    try {
      setTraining(true);
      setShowTrainingModal(true);
      const response = await axios.post(`${BASE_URI}/api/processWoocommerceProductTraining`, { 
        vendor_id: vendorId 
      }, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
  ...
  const handleTrainMetaAgent = async () => {
    try {
      setTraining(true);
      setShowTrainingModal(true);
      const response = await axios.post(`${BASE_URI}/api/processMetaProductTraining`, { 
        vendor_id: vendorId 
      }, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
  ...
  const handleTrainKnowledgeBase = async () => {
    ...
    try {
      setTraining(true);
      setShowTrainingModal(true);
      const response = await axios.post(`${BASE_URI}/api/trainKnowledgeBase`, { 
        vendor_id: vendorId,
  ...
  const fetchInitialStatuses = async () => {
    if (!vendorId) return;
    try {
      const resp = await axios.post(`${BASE_URI}/api/getActivePlatform`, { vendor_id: vendorId }, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
      if (resp.data.status) {
  ...
  const fetchKnowledgeBase = async () => {
    ...
    try {
      setSyncing(true);
      const response = await axios.post(`${BASE_URI}/api/viewKnowledgeBase`, { 
        vendor_id: vendorId 
      }, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
      if (response.data.status) {
  ...
  const handleSourceToggle = async (title, checked, e) => {
    ...
    if (checked) {
      ...
      try {
        ...
        await axios.post(`${BASE_URI}/api/updateActivePlatform`, { 
          vendor_id: vendorId,
  ...
  const ShopifyConfig = () => {
    ...
    const fetchToken = async () => {
      ...
      try {
        setLoading(true);
        const response = await axios.post(`${BASE_URI}/api/getShopifyToken`, { vendor_id: vendorId }, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
    ...
    const handleSave = async () => {
      ...
      try {
        ...
        const response = await axios.post(`${BASE_URI}/api/saveShopifyToken`, formData, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
  ...
  const WooCommerceConfig = () => {
    ...
    const fetchToken = async () => {
      ...
      try {
        setLoading(true);
        const response = await axios.post(`${BASE_URI}/api/getWoocommerceToken`, { vendor_id: vendorId }, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
        if (response.data.status && response.data.data) {
          const data = response.data.data;
          setWooData({
    ...
    const handleSave = async () => {
      ...
      try {
        ...
        const response = await axios.post(`${BASE_URI}/api/saveWoocommerceToken`, formData, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
  ...
  const MetaConfig = () => {
    ...
    const fetchToken = async () => {
      ...
      try {
        setLoading(true);
        const response = await axios.post(`${BASE_URI}/api/getMetaToken`, { vendor_id: vendorId }, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
        if (response.data.status && response.data.data) {
          const data = response.data.data;
          setMetaData({
    ...
    const handleSave = async () => {
      ...
      try {
        ...
        const response = await axios.post(`${BASE_URI}/api/saveMetaToken`, formData, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
...
const ActionsContent = ({ vendorId }) => {
  ...
  const fetchUsers = async () => {
    try {
      const response = await axios.post(`${BASE_URI}/api/get-users`, { vendorId: vendorId }, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
      if (response.data.status) {
  ...
  const fetchAiBotSettings = async () => {
    ...
    try {
      setLoading(true);
      const response = await axios.post(`${BASE_URI}/api/aiBotSettingView`, { vendorId: vendorId }, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
  ...
  const handleSaveActions = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${BASE_URI}/api/enableDisableAiBot`, payload, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
...
const AiStopContactsContent = ({ vendorId }) => {
    ...
    const fetchStoppedContacts = async () => {
        ...
        try {
            setLoading(true);
            const response = await axios.post(`${BASE_URI}/api/aiStopedChats`, { vendorId: vendorId }, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
    ...
    const handleResumeAi = async (id) => {
        try {
            const response = await axios.post(`${BASE_URI}/api/deleteAiStopedChats`, { id: id }, { headers: { Authorization: `Bearer ${localStorage.getItem('token')}` } });
            if (response.data.status) {
