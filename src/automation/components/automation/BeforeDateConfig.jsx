...
export function BeforeDateConfigPanel({ config, onChange, customFields = [] }) {
    ...
    return (
        <div className="space-y-4">
            <div className="border border-gray-200 rounded-xl p-5 shadow-sm bg-white">
                <div className="mb-4">
                    <h3 className="text-[15px] font-semibold text-gray-900">Before Date</h3>
                    <p className="text-[13px] text-gray-500 mt-0.5">Trigger X days before a reference date field</p>
                </div>
                ...
                <div className="space-y-6 mt-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                         <div className="space-y-1.5 focus-within:text-primary transition-colors">
                            <Label className="text-[13px] text-gray-700 font-medium">Days Before</Label>
                            <Input 
                                type="number" 
                                min="0"
