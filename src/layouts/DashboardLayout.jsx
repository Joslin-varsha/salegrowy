...
import { Bell, User, LayoutDashboard, Gift, Grid, MessageCircle, Clock, Anchor, Megaphone, List, Wallet, Users, Share2, Layers, ChevronRight, ArrowLeft, TrendingUp, Waypoints, Settings as SettingsIcon } from 'lucide-react';
  ...
  <div key={index}>
    ...
    {item.hasSubmenu ? (
      ...
      <div
        ...
        style={{
          color: isActive ? 'var(--wa-green)' : '#475569',
          display: 'flex',
          alignItems: 'center',
          width: '100%',
...
useEffect(() => {
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#ffffff' }}>
      ...
      <div style={{ 
  flex: 1, 
  marginLeft: isLargeScreen ? '260px' : '64px', display: 'flex', flexDirection: 'column' }}>
        <Topbar isLargeScreen={isLargeScreen} />
        <main style={{ padding: '1.5rem 2rem', marginTop: '60px', flex: 1, overflowX: 'hidden' }}>
          <Outlet />
        </main>
      </div>
    </div>
